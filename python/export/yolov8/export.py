...
# Desc    :   This script exports a YOLOv8 model to ONNX.
# ==============================================================================
import os
import sys
import argparse
...
import torch
from common import Detect as DetectNMS
...
class Exporter:
    ...
    def __call__(self, model=None) -> None:
        ...
        # Input
        im = torch.zeros(self.args.batch, 3, *self.imgsz, dtype=torch.float).to(self.device)

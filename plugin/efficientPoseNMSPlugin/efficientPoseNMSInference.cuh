...
// # 0: 鼻子 1: 左眼 2：右眼 3：5: 左肩 6: 右肩 7: 左肘 8: 右肘 9: 左腕 10: 右腕 11: 左髋 12: 右髋 13: 左膝 14: 右膝 15: 左踝 16: 右踝

template <typename T>
struct KeyPoints
{
    // For NMS/IOU purposes, YXYX coding is identical to XYXY
    // KeyPoint<T> nose, leye, reye, lear, rear, lshoulder, rshoulder, lelbow, relbow, lwrist, rwrist, lhip, rhip, lknee, rknee, lankle, rankle;
    KeyPoint<T> kpts[17];
};

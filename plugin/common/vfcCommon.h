...
#if (NV_TENSORRT_MAJOR < 10 || (NV_TENSORRT_MAJOR == 10 && NV_TENSORRT_MINOR == 0))
extern "C" TENSORRTAPI nvinfer1::IPluginCreator *const *getPluginCreators(int32_t &nbCreators);
#endif

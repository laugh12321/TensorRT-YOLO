...
def main():
    ...
    model = TRTYOLO(args.engine, task="segment", swap_rb=True, profile=True)
    ...
    if input_path.is_dir():
        ...
        if args.output:
            for image_name, image, result in zip(image_names, images, results):
                ...
                annotated_frame = mask_annotator.annotate(scene=annotated_frame, detections=result)

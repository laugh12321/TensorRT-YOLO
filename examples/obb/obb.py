...
# Date    :   2024/11/12 22:00:17
# Desc    :   YOLO Series Inference For OBB Detection.
# ==============================================================================
import argparse
import sys
...
from tensorrt_yolo.infer import CpuTimer, DeployCGOBB, DeployOBB, GpuTimer, generate_labels_with_colors, image_batches, visualize
...
def main():
    ...
    model = DeployCGOBB(args.engine) if args.cudaGraph else DeployOBB(args.engine)

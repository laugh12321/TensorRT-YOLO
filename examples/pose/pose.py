...
from tensorrt_yolo.infer import InferOption, PoseModel, generate_labels, image_batches, visualize
...
def main():
    ...
    model = PoseModel(args.engine, option)
